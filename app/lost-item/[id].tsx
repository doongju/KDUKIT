        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.date}>
                    {item.createdAt?.toDate().toLocaleString()} 등록
                </Text>
...
const styles = StyleSheet.create({
    ...
    imageContainer: {
        width: '100%', height: 300, borderRadius: 12, overflow: 'hidden', marginBottom: 20,
        backgroundColor: '#f0f0f0', elevation: 3,
    },
    ...
    descriptionBox: {
        backgroundColor: '#f9f9f9', padding: 15, borderRadius: 10, minHeight: 100,
    },
